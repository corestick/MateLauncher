 ...
 * 
 */
public class ScreenLayout implements Animation.AnimationListener,
		OnClickListener {
	...
	ScreenLayout(View layout) {
		...
		inAnim = AnimationUtils.loadAnimation(layout.getContext(),
				R.anim.scale_fade_in);
		inAnim.setAnimationListener(this);

		outAnim = AnimationUtils.loadAnimation(layout.getContext(),
	...
	boolean isFilled(Bitmap[] screens) {
		return mLine1.getChildCount() + mLine2.getChildCount()
				+ mLine3.getChildCount() == screens.length;
	}
