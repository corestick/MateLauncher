...
public final class Launcher extends Activity implements View.OnClickListener, OnLongClickListener,
    ...
    private SlidingDrawer mDrawer; //슬라이딩 기능
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppWidgetHost = new LauncherAppWidgetHost(this, APPWIDGET_HOST_ID); //위젯 관련 객체
        ...
        checkForLocaleChange(); // 핸드폰 내부 설정 값
        setWallpaperDimension();// 배경화면 크기 설정
    ...
    private void checkForLocaleChange() {
        ...
        readConfiguration(this, localeConfiguration);//설정값 읽어 드림  
    ...
    private static void readConfiguration(Context context, LocaleConfiguration configuration) {
        ...
        try {
            ...
            configuration.mnc = in.readInt();//설정값을 프리퍼런스로 읽어드림
    ...
    protected void onResume() {
        ...
        keepIndicatorOn = PreferenceManager.getDefaultSharedPreferences(this).getBoolean(
                getString(R.string.key_indicator_on), false);
    ...
    public Object onRetainNonConfigurationInstance() {
        ...
        return null;
    }//화면 전환시 현재 값을 저장 하는 방법  -화면 전환하면 onCreat() 부름.
    ...
    private void completeAddShortcut(Intent data, CellLayout.CellInfo cellInfo,
            boolean insertAtFirst) {
        cellInfo.screen = mWorkspace.getCurrentScreen();
        if (!findSingleSlot(cellInfo)) //슬롯이 꽉 찻을경우
            return;
    ...
    class SwitcherTask extends AsyncTask<Integer, Integer, Integer> {
        ...
        protected void onPreExecute() {
            Toast.makeText(Launcher.this, R.string.starting_screen_switcher, Toast.LENGTH_SHORT)
                    .show();
        }
    ...
    private boolean syncScreenNumber() {
        if (mWorkspace == null)
            return false;
        try {
            int number = Integer.parseInt(PreferenceManager.getDefaultSharedPreferences(this)
                    .getString(getString(R.string.key_screen_number), "3"));
            ...
            if (number < count) {
                ...
                for (int i = number - count; i >= 1; i--)
                    mWorkspace.addView(mInflater.inflate(R.layout.workspace_screen, null));
                return true;
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (TextUtils.equals(getString(R.string.key_default_screen), key)) {
            ...
            if (mWorkspace != null) {
                int screen = Integer.parseInt(PreferenceManager.getDefaultSharedPreferences(this)
                        .getString(key, "2"));
