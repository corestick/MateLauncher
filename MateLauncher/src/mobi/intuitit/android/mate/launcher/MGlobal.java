...
public final class MGlobal {
	...
	//Mobject 의 타입; 가구, 아바타, 위젯
	public static final int MOBJECTTYPE_FURNITURE = 0;
	public static final int MOBJECTTYPE_AVATAR = 1;
	public static final int MOBJECTTYPE_WIDGET = 2;
