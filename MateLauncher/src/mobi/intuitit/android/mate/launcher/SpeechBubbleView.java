...
public class SpeechBubbleView extends LinearLayout implements
	...
	//설치된 앱 목록 알아오기
		public void selectApp(long appid) {
			final long id = appid;
			...
			listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parentView, View view,
					...
					Intent intent = mLauncher.getPackageManager().getLaunchIntentForPackage(setupAppPacName.get(position));
					 values.put(LauncherSettings.BaseLauncherColumns.INTENT, intent.toUri(0));
					 cr.update(LauncherSettings.Favorites.getContentUri(id, false),
								values, null, null);
